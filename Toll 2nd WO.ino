...
#define FIREBASE_HOST "toll-management-ed405-default-rtdb.firebaseio.com"
#define FIREBASE_AUTH "ZAoGcwjUs98VgzFRCQhyIi3Cir5emJfUNhehf4hI"
//#define WIFI_SSID "Vannga"
//#define WIFI_PASSWORD "Firoj12345"
...
int getCardID() {
  ...
  if (content.substring(1) == "22 5A FF 34")
  {
    beep();
    return 0;
  }
